...
class DashboardData {
  ...
  factory DashboardData.dummy() {
    return DashboardData(
      ...
      persentasePerbandinganPekanLalu: 19.2, // misal naik 19.2% dari pekan lalu
      kasusTerbanyak: "Flu",
      ...
      rujukanHariIni: [
        ...
        Santri(id: '2', nama: 'Rizki Hidayat', jenjang: 9, tahunMasuk: 2020),
      ],
      sakitHariIni: [
        Santri(id: '3', nama: 'Fajar Sidik', jenjang: 7, tahunMasuk: 2022),
        Santri(id: '4', nama: 'Rafli Ananda', jenjang: 8, tahunMasuk: 2021),
        Santri(id: '5', nama: 'Ilham Ramadhan', jenjang: 9, tahunMasuk: 2020),
      ],
    );
  }
}
